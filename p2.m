clc;
%% 1) I guess this would be the first step
...
new_binary = mybinaryfun(new_picture, 90);
figure;
imshow(new_binary);
...
fileID = fopen('recognized_output2.txt', 'w'); % Open file for writing
fprintf(fileID, '%s', final_output); % Write the recognized characters
fclose(fileID); % Close the file
disp('Recognized output saved to recognized_output2.txt');
